...
trait BaseModule extends ScalaJSModule {
  ...
  override def scalacPluginIvyDeps =
    super.scalacPluginIvyDeps() ++
      (scalaVersion() match {
        case scalalib.api.Util.PartialVersion("2", _) =>
          Agg(ivy"org.typelevel::kind-projector:0.10.3")
        case _ => Nil
      })
}

object zycle extends CrossO[zycle]
class zycle(val scalaCross: String, val scalaJSCross: String)
  extends BaseModule
    with PublishModule {
  ...
  override def artifactName = "cycle-zstream"
