...
object ComposeDriver {
  ...
  private type User[I, O]   = DIO[I, O] => ModEl
  private type Driver[I, O] = User[I, O] => ModEl

  private type User2[I1, O1, I2, O2]   = (DIO[I1, O1], DIO[I2, O2]) => ModEl
  private type Driver2[I1, O1, I2, O2] = User2[I1, O1, I2, O2] => ModEl

  private type User3[I1, O1, I2, O2, I3, O3]   = (DIO[I1, O1], DIO[I2, O2], DIO[I3, O3]) => ModEl
  private type Driver3[I1, O1, I2, O2, I3, O3] = User3[I1, O1, I2, O2, I3, O3] => ModEl

  private type User4[I1, O1, I2, O2, I3, O3, I4, O4]   = (DIO[I1, O1], DIO[I2, O2], DIO[I3, O3], DIO[I4, O4]) => ModEl
