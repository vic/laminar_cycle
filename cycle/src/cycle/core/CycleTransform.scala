...
class CycleTransform[-I, +S, +O] private[cycle] (private val cycle: Cycle[I, S, O])
    extends AnyVal {

  def triMap[I0, S0, O0](f: I0 => I, g: S => S0, h: O => O0): Cycle[I0, S0, O0] =
    new Cycle[I0, S0, O0] {
  ...
  def withModifiers(mods: Mod[Base]*): Cycle[I, S, O] =
    new Cycle[I, S, O] {
